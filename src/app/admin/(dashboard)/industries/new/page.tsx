    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Create a new product industry</p>
        </div>
      </div>

      <div className="bg-white rounded-2xl shadow-soft border border-slate-100 p-6">
        <SubmitForm action={createIndustry} className="space-y-6">
          ...
          <div>
            ...
            <RichTextEditor name="description" placeholder="Write a description for this industry..." />
          </div>
