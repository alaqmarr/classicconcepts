...
export default function NewProblemStatementPage() {
  async function createProblemStatement(formData: FormData) {
    "use server";
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            ...
            Add New ProblemStatement
          </h1>
          <p className="text-sm text-slate-500 mt-1">Create a new product problemStatement</p>
        </div>
      </div>

      <div className="bg-white rounded-2xl shadow-soft border border-slate-100 p-6">
        <SubmitForm action={createProblemStatement} className="space-y-6">
          ...
          <div>
            ...
            <RichTextEditor name="description" placeholder="Write a description for this problemStatement..." />
          </div>
          ...
          <div>
            ...
            <input type="text" name="description" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0056b3] focus:bg-white transition-all text-sm" placeholder="e.g. bg-blue-500" />
          </div>
